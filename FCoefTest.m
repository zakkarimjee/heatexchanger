...
F2 = ((R^2+1)^0.5)*log(((1-P*R)/(1-P))^(1/n))/(R-1)*...
log(1+((1-P*R)/(1-P))^(1/n)-((R^2+1)^0.5)/(R-1)+((R^2+1)^0.5)*((1-R*P)/(1-P))^(1/n)/(R-1)/...
(1+((1-P*R)/(1-P))^(1/n)+((R^2+1)^0.5)/(R-1)-((R^2+1)^0.5)*((1-R*P)/(1-P))^(1/n)/(R-1)));

F2vec = ((R^2+1)^0.5).*log(((1-P*R)./(1-P)).^(1/n))./(R-1).*...
log(1+((1-P*R)./(1-P)).^(1/n)-((R^2+1)^0.5)/(R-1)+((R^2+1)^0.5)*((1-R*P)./(1-P)).^(1/n)./(R-1))./...
log(1+((1-P*R)./(1-P)).^(1/n)+((R^2+1)^0.5)/(R-1)-((R^2+1)^0.5)*((1-R*P)./(1-P)).^(1/n)/(R-1));
...
F3vec = S*log(W)./log((1+W-S+S*W)./(1+W+S-S*W));
F4vec = ((R^2+1)^0.5)/(R-1)*log(((1-P*R)./(1-P)).^(1/n))./...
